...
All experiments are reproducible on a single RTX 3060 (12GB) from a cloned repository:

\begin{verbatim}
git clone https://github.com/zabwie/TTKV && cd TTKV
pip install -e ".[dev]"
bash reproduce.sh
\end{verbatim}

Results are saved to \texttt{results/real\_compression\_qwen.json}. For use as a library, install from PyPI: \texttt{pip install ttkv}.
